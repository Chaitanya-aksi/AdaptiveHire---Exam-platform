        ...
        <section className="auth-right" aria-hidden="true">
          ...
          <div className="ar-inner">
            ...
            <div className="ar-illus">
              ...
              <span className="ar-calc ar-calc--3">A → C → F → J → ?</span>
              <span className="ar-calc ar-calc--4">72 ÷ 8 = 9</span>

              {/* Device ambient glow */}
              <div className="ar-device-glow" />
              ...
              {/* Performance score chip — top-right */}
              ...
              {/* Micro assessment cards — glassmorphism, floating */}
              <div className="ar-micro ar-micro--apt">
              ...
              <div className="ar-micro ar-micro--rsn">
                <span className="ar-micro-ico">🧩</span>
                <div className="ar-micro-data">
              ...
              <div className="ar-micro ar-micro--adp">
                <span className="ar-micro-ico">🔄</span>
                <div className="ar-micro-data">
              ...
              {/* Adaptive engine active — pulsing indicator */}
              <div className="ar-engine">
